...
<head>
	...
	<body>
		...
		<div id='main'>
			...
			<div class="container">
            <h3>New Note</h3>
            <form onsubmit="return validate()" action="NewNoteServlet" method="post">
            
                <label for="note">Note</label><br>
                <input type="text" id="note" name="note"><br>
                <div id="note_error" style="display:none; color:red; font-size:13px;">Please enter Note</div>
                ...
                <button id="create" class="submit-button btn-success">Create</button>
		...
		<script>
            function validate(){
            	...
            	if(note==""){
            		temp=false;
       				document.getElementById("note_error").style.display='block';
            	}else{
            		document.getElementById("note_error").style.display='none';
            	}
            	if(description==""){
            		temp=false;
